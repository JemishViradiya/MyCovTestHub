...
<body>
	...
	<div class="container">
		<h1 style="color: #f44336; margin: 20px">MyCoVTestHub DashBoard</h1>
		
			<a style='text-decoration: none;float:right; margin-top: -50px;
			' href="upload.jsp" ><button
			id="report" class="btn btn-default" style="border: 1px solid #f44336;margin-bottom: 15px">Upload Report</button></a>
		...
		<section class="progress-bars3 cid-si4AFdrhWo" id="progress-bars3-1q">
			<h3
				...
				style="color: #600557">Demographics statistics</h3>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="card"
					...
					<h3 style="color: #600557;">
						<strong>Case Ratio</strong>
					</h3>
					<div id="piechart"></div>
			...
			<div class="col-sm-6">
				<div class="card" style="overflow-x: auto;">
					<h3 style="color: #600557;">
						<strong>Distribution by postcode</strong>
					</h3>
					<div class="table-wrap">
						<table class="table" style="background-color: white;">

							<thead>
								<tr style="background-color: #91cc24; color: white;">
		...
		<h3 style="color: #600557;"><strong>MyCoVTest Hub</strong></h3>
